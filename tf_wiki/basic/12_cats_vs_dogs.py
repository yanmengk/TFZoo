...
if __name__ == "__main__":
    ...
    train_labels = tf.concat([
        tf.zeros(train_cats_filenames.shape, dtype=tf.int32),
        tf.ones(train_dogs_filenames.shape, dtype=tf.int32)],
        axis=-1)
    ...
    train_dataset = train_dataset.shuffle(buffer_size=23000).batch(batch_size=batch_size) \
